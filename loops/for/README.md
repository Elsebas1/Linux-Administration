...
The `for` loop is a control structure that allows you to iterate over data sequences or execute a block of code a specific number of times. Unlike the `while` loop, the `for` loop is primarily designed for defining iterations. 
